(function() {
    ...
    HomeCtrl.$inject = ['$rootScope', '$state', '$mdUtil', '$mdSidenav', 'grupoService', 'loginService', 'config'];
    /* @ngInject */
    function HomeCtrl($rootScope, $state, $mdUtil, $mdSidenav, grupoService, loginService, config) {
        var vm = this;
